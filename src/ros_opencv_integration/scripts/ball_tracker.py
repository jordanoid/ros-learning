...
def ball_detection(video_frame):
    yellowLower =(30, 100, 100)
    yellowUpper = (60, 255, 255)
    binary_image_mask = filter_color(video_frame, yellowLower, yellowUpper)
    contours = getContours(binary_image_mask)
    draw_ball_contour(binary_image_mask, video_frame,contours)

def main():
    video_file = "/home/jordano/catkin_ws/src/ros_opencv_integration/video/tennis-ball-video.mp4"
